<template>
  <div class="pagination">
    <button @click="changeBtn">首页</button>   <!--changeBtn不给参数传递的是event对象-->
      ...
      methods:{
        changeBtn(page){
          ...
          if(page == this.pagebtns[4]){
            ...
            this.pagebtns.splice(4,0,page+1) // 添加最后一个
          }else if(page == this.pagebtns[0] && page !=1 ){
            this.pagebtns.unshift(this.pagebtns[0]-1) // 第一个位置添加一个元素
